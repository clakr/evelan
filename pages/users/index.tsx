      ...
      <main className="max-w-4xl mx-auto grid grid-cols-3 gap-4 min-h-screen py-8">
        ...
        {users.length > 0 && (
          <div className="col-span-full flex flex-col items-center gap-4">
            {/* Load More Button */}
            <button
              className="bg-blue-600 text-white px-8 py-2 rounded-xl font-medium w-fit hover:scale-105 shadow-lg shadow-blue-300 disabled:hover:scale-100 disabled:opacity-50 disabled:cursor-not-allowed"
              onClick={handleClick}
        ...
        {users.length === 0 && (
          <div className="text-5xl col-span-full my-auto text-center flex flex-col gap-4">
            There&apos;s nothing here.
            <button
              className="text-blue-400 underline text-3xl underline-offset-4"
              onClick={() => router.back()}
            >
              &lt; Go back
            </button>
